...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <head>
        <meta charset="utf-8"/>
        <title>Протокол поверки СРМ с помощью ТПУ и ПП по МИ 3189-2009</title>
      </head>
      ...
      <body scroll="no" >
        ...
        <div align="center">
          ПРОТОКОЛ № <xsl:value-of select="PbmmVerification/DataHeader/ProtN"/>
        </div>
        <div align="center">поверки СРМ с помощью ТПУ и ПП по МИ 3189-2009</div>
        <br/>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения поверки: <xsl:value-of select="PbmmVerification/DataHeader/Place"/>
              </td>
            </tr>
			...
			<tr>
              ...
              <td align="left" width="20%">
                <xsl:value-of select="PbmmVerification/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="PbmmVerification/DataHeader/CurFM_Num"/>
              </td>
              <td align="right" width="15%">Линия №</td>
              <td align="left" width="15%">
                <xsl:value-of select="PbmmVerification/DataHeader/Len_Num"/>
              </td>
            </tr>
			...
			<tr>
              ...
              <td align="left" width="20%">
                <xsl:value-of select="PbmmVerification/DataHeader/CurFM_NamTr1"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="PbmmVerification/DataHeader/CurFM_Num1"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" width="20%">
                <xsl:value-of select="PbmmVerification/DataHeader/TPU_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="PbmmVerification/DataHeader/TPU_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" width="20%">
                <xsl:value-of select="PbmmVerification/DataHeader/PP_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="PbmmVerification/DataHeader/PP_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" width="20%">
                <xsl:value-of select="PbmmVerification/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="PbmmVerification/DataHeader/IVK_Num"/>
              </td>
            </tr>
			
            <tr>
              <td align="left" width="25%" >
                Рабочая жидкость: <xsl:value-of select="PbmmVerification/DataHeader/Prod_Name"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbmmVerification/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbmmVerification/DataTab12">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="77%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbmmVerification/DataTab13">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbmmVerification/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="77%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center">
                <xsl:value-of disable-output-escaping="yes" select="PbmmVerification/DataHeader/Tab2End_KMod"/>
              </td>
            </tr>
            <tr>
              <td align="center" width="11%">1 </td>
          ...
          <tbody>
            <xsl:for-each select="PbmmVerification/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center">
                <xsl:value-of disable-output-escaping="yes" select="PbmmVerification/DataHeader/Tab3_KMod"/>
              </td>
              <td align="center">
                n<sub>j</sub>
              </td>
          ...
          <tbody>
            <xsl:for-each select="PbmmVerification/DataTab3">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center">
                <xsl:value-of disable-output-escaping="yes" select="PbmmVerification/DataHeader/Tab4_KMod"/>
              </td>
              <td align="center">
                S<sub>0</sub>,<br/>%
              </td>
          ...
          <tbody>
            <xsl:for-each select="PbmmVerification/DataTab4">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="77%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbmmVerification/DataTab31">
              <tr>
                <td align="center">
        ...
        <br/>
        <div>
          Дата проведения поверки:&#160;<xsl:value-of select="PbmmVerification/DataHeader/STime"/>
        </div>
