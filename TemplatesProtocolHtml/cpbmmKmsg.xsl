...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <head>
        <meta charset="utf-8"/>
        <title>Протокол определения коэффициента преобразования СРМ с помощью ПУ и ПП</title>
      </head>
      ...
      <body scroll="no" >
        <div align="center">
          ПРОТОКОЛ № <xsl:value-of select="cpbmmKmsg/DataHeader/ProtN"/>
        </div>
        <div align="center">
          определения коэффициента преобразования СРМ с помощью ПУ и ПП
        </div>
        <br/>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения калибровки: <xsl:value-of select="cpbmmKmsg/DataHeader/Place"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="10%">СРМ: Датчик: Тип:</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/CurFM_Num"/>
              </td>
              <td align="right" width="15%">Линия №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/Len_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="10%">Преоб.: Тип: </td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/CurFM_NamTr1"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/CurFM_Num1"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="10%">ПУ: Тип: </td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/TPU_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/TPU_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="10%">ПП: Тип: </td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/PP_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/PP_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="10%">ИВК: Тип: </td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmKmsg/DataHeader/IVK_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="25%" >
                Рабочая жидкость: <xsl:value-of select="cpbmmKmsg/DataHeader/Prod_Name"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="cpbmmKmsg/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="66%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="cpbmmKmsg/DataTab12">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="cpbmmKmsg/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="77%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="cpbmmKmsg/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="cpbmmKmsg/DataTab3">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="77%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="cpbmmKmsg/DataTab31">
              <tr>
                <td align="center">
                  <xsl:value-of select="j"/>
                </td>
        ...
        <br/>
        <div>
          Дата:&#160;<xsl:value-of select="cpbmmKmsg/DataHeader/STime"/>
        </div>
