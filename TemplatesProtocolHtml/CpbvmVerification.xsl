...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <head>
        <meta charset="utf-8"/>
        <title>Поверка ПР с помощью ПУ по МИ 3287-2010</title>
      </head>
      ...
      <body scroll="no" >
        <div align="center">ПРОТОКОЛ № <xsl:value-of select="CpbvmVerification/DataHeader/ProtN"/></div>
        <div align="center">поверки ПР с помощью ПУ по МИ 3287-2010</div>
        <br/>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения поверки: <xsl:value-of select="CpbvmVerification/DataHeader/Place"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="20%">Тип ПР:</td>
              <td align="left" width="20%">
                <xsl:value-of select="CpbvmVerification/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="CpbvmVerification/DataHeader/CurFM_Num"/>
              </td>
              <td align="right" width="15%">Линия №</td>
              <td align="left" width="10%">
                <xsl:value-of select="CpbvmVerification/DataHeader/Len_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" >Тип ПУ:</td>
              <td align="left" >
                <xsl:value-of select="CpbvmVerification/DataHeader/CPB_NamTr"/>
              </td>
              <td align="left" >Заводской №</td>
              <td align="left" colspan="3">
                <xsl:value-of select="CpbvmVerification/DataHeader/CPB_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" >Тип ИВК:</td>
              <td align="left" >
                <xsl:value-of select="CpbvmVerification/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" >Заводской №</td>
              <td align="left" colspan="3">
                <xsl:value-of select="CpbvmVerification/DataHeader/IVK_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" >
                <xsl:value-of select="CpbvmVerification/DataHeader/Prod_Name"/>
              </td>
              <td align="left" >
                Вязкость, мм<sup>2</sup>/c
              </td>
              <td align="left" colspan="3">
                <xsl:value-of select="CpbvmVerification/DataHeader/Prod_KVis"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="89%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerification/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="78%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerification/DataTab12">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerification/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerification/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerification/DataTab3">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerification/DataTab4">
              <tr>
                <td align="center">
        ...
        <br/>
        <div>Дата проведения поверки:&#160;<xsl:value-of select="CpbvmVerification/DataHeader/STime"/></div>
