...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body scroll="no">
        <div align="center">
          ПРОТОКОЛ №<xsl:value-of select="PbvmVerificationEtalon/DataHeader/ProtN"/>
        </div>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения поверки: <xsl:value-of select="PbvmVerificationEtalon/DataHeader/Place"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="20%">Тип ЭПР:</td>
              <td align="left" width="20%">
                <xsl:value-of select="PbvmVerificationEtalon/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="PbvmVerificationEtalon/DataHeader/CurFM_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" >
                <xsl:value-of select="PbvmVerificationEtalon/DataHeader/PB_NamTr"/>
              </td>
              <td align="left" >Заводской №</td>
              <td align="left" colspan="3">
                <xsl:value-of select="PbvmVerificationEtalon/DataHeader/PB_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" >
                <xsl:value-of select="PbvmVerificationEtalon/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" >Заводской №</td>
              <td align="left" colspan="3">
                <xsl:value-of select="PbvmVerificationEtalon/DataHeader/IVK_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" >
                <xsl:value-of select="PbvmVerificationEtalon/DataHeader/Prod_Name"/>
              </td>
              <td align="left" >
                Вязкость, мм<sup>2</sup>/c
              </td>
              <td align="left" colspan="3">
                <xsl:value-of select="PbvmVerificationEtalon/DataHeader/Prod_KVis"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbvmVerificationEtalon/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="66%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbvmVerificationEtalon/DataTab12">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbvmVerificationEtalon/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center" width="11%">
                <xsl:value-of disable-output-escaping="yes" select="PbvmVerificationEtalon/DataHeader/Tab2_Arg"/>
              </td>
              <td align="center" width="11%">
                N<sub>ji</sub>,<br/>имп
              </td>
          ...
          <tbody>
            <xsl:for-each select="PbvmVerificationEtalon/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center" width="11%">
                <xsl:value-of disable-output-escaping="yes" select="PbvmVerificationEtalon/DataHeader/Tab3_Arg"/>
              </td>
              <td align="center" width="11%">
          ...
          <tbody>
            <xsl:for-each select="PbvmVerificationEtalon/DataTab3">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbvmVerificationEtalon/DataTab4">
              <tr>
                <td align="center">
        ...
        <br/>
        <div>
          Дата проведения поверки:&#160;<xsl:value-of select="PbvmVerificationEtalon/DataHeader/STime"/>
        </div>
