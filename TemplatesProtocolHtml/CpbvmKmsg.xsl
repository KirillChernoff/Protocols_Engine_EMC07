...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body scroll="no" >
        <div align="center">
          ПРОТОКОЛ № <xsl:value-of select="CpbvmKmsg/DataHeader/ProtN"/>
        </div>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения калибровки: <xsl:value-of select="CpbvmKmsg/DataHeader/Place"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="20%">Тип ПР:</td>
              <td align="left" width="20%">
                <xsl:value-of select="CpbvmKmsg/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="CpbvmKmsg/DataHeader/CurFM_Num"/>
              </td>
              <td align="right" width="15%">Линия №</td>
              <td align="left" width="10%">
                <xsl:value-of select="CpbvmKmsg/DataHeader/Len_Num"/>
              </td>
            </tr>
            <tr >
              <td align="left" >Тип ПУ:</td>
              <td align="left" >
                <xsl:value-of select="CpbvmKmsg/DataHeader/CPB_NamTr"/>
              </td>
              <td align="left" >Заводской №</td>
              <td align="left" colspan="3">
                <xsl:value-of select="CpbvmKmsg/DataHeader/CPB_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" >Тип ИВК:</td>
              <td align="left" >
                <xsl:value-of select="CpbvmKmsg/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" >Заводской №</td>
              <td align="left" colspan="3">
                <xsl:value-of select="CpbvmKmsg/DataHeader/IVK_Num"/>
              </td>
            </tr>
            ...
            <tr >
              ...
              <td align="left" >
                <xsl:value-of select="CpbvmKmsg/DataHeader/Prod_Name"/>
              </td>
              <td align="left" >
                Температура, ºC
              </td>
              <td align="left">
                <xsl:value-of select="CpbvmKmsg/DataHeader/Prod_Tem"/>
              </td>			  
              <td align="right" >
                Вязкость, мм<sup>2</sup>/c
              </td>
              <td align="left" >
                <xsl:value-of select="CpbvmKmsg/DataHeader/Prod_KVis"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="89%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmKmsg/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="56%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmKmsg/DataTab12">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmKmsg/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="86%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmKmsg/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmKmsg/DataTab3">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="55%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmKmsg/DataTab4">
              <tr>
                <td align="center">
                  <xsl:value-of select="j"/>
                </td>
        ...
        <br/>
        <div>
          Дата:&#160;<xsl:value-of select="CpbvmKmsg/DataHeader/STime"/>
        </div>
