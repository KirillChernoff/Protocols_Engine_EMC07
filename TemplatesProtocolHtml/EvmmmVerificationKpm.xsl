...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body scroll="no" >
        <div align="center">ПРОТОКОЛ №&#160;<xsl:value-of select="EvmmmVerificationKpm/DataHeader/ProtN"/></div>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения поверки: <xsl:value-of select="EvmmmVerificationKpm/DataHeader/Place"/>
              </td>
            </tr>
            <tr height="25">
              ...
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/CurFM_Num"/>
              </td>
              <td align="right" width="15%">Линия №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/CurFM_Len_Num"/>
              </td>
            </tr>
            <tr height="25">
              ...
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/CurFM_NamTr1"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/CurFM_Num1"/>
              </td>
            </tr>
            <tr height="25">
              ...
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/EFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/EFM_Num"/>
              </td>
            </tr>
            <tr height="25">
              ...
              <td align="left" width="20%">Тип:</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/PP_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/PP_Num"/>
              </td>
            </tr>
            <tr height="25">
              ...
              <td align="left" width="20%">Тип:</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKpm/DataHeader/IVK_Num"/>
              </td>
            </tr>
            <tr height="25">
              <td align="left" width="50%" colspan="5">
                Рабочая жидкость:&#160;<xsl:value-of select="EvmmmVerificationKpm/DataHeader/Prod_Name"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKpm/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKpm/DataTab12">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKpm/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;" border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKpm/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKpm/DataTab3">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKpm/DataTab4">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="66%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKpm/DataTab42">
              <tr>
                <td align="center">
        ...
        <br/>
        <div>
          Дата проведения поверки:&#160;<xsl:value-of select="EvmmmVerificationKpm/DataHeader/STime"/>
        </div>
      </body>
    </html>
