...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body scroll="no" >
        <div align="center">
          ПРОТОКОЛ №<xsl:value-of select="CpbvmVerificationEtalon/DataHeader/ProtN"/>
        </div>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения поверки: <xsl:value-of select="CpbvmVerificationEtalon/DataHeader/Place"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="20%">Тип ЭПР:</td>
              <td align="left" width="20%">
                <xsl:value-of select="CpbvmVerificationEtalon/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="CpbvmVerificationEtalon/DataHeader/CurFM_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" >Тип ПУ:</td>
              <td align="left" >
                <xsl:value-of select="CpbvmVerificationEtalon/DataHeader/CPB_NamTr"/>
              </td>
              <td align="left" >Заводской №</td>
              <td align="left" colspan="3">
                <xsl:value-of select="CpbvmVerificationEtalon/DataHeader/CPB_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" >Тип ИВК:</td>
              <td align="left" >
                <xsl:value-of select="CpbvmVerificationEtalon/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" >Заводской №</td>
              <td align="left" colspan="3">
                <xsl:value-of select="CpbvmVerificationEtalon/DataHeader/IVK_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" >
                <xsl:value-of select="CpbvmVerificationEtalon/DataHeader/Prod_Name"/>
              </td>
              <td align="left" >
                Вязкость, мм<sup>2</sup>/c
              </td>
              <td align="left" colspan="3">
                <xsl:value-of select="CpbvmVerificationEtalon/DataHeader/Prod_KVis"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerificationEtalon/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="66%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerificationEtalon/DataTab12">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerificationEtalon/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerificationEtalon/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerificationEtalon/DataTab3">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="CpbvmVerificationEtalon/DataTab4">
              <tr>
                <td align="center">
        ...
        <br/>
        <div>Дата проведения поверки:&#160;<xsl:value-of select="CpbvmVerificationEtalon/DataHeader/STime"/></div>
