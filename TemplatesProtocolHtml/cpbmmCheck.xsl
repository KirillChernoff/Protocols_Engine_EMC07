  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body scroll="no" >
        ...
        <div align="center">
          ПРОТОКОЛ № <xsl:value-of select="cpbmmCheck/DataHeader/ProtN"/>
        </div>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения КМХ: <xsl:value-of select="cpbmmCheck/DataHeader/Place"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="10%">ПР: Датчик: Тип:</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/CurFM_Num"/>
              </td>
              <td align="right" width="15%">Линия №</td>
              <td align="left" width="15%">
                <xsl:value-of select="cpbmmCheck/DataHeader/Len_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="10%">ПР: Преоб.: Тип: </td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/CurFM_NamTr1"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/CurFM_Num1"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="10%">ТПУ: Тип: </td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/TPU_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/TPU_Num"/>
              </td>
              <td align="right" width="15%">Дата поверки:</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/TPU_PrDate"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="10%">ПП: Тип: </td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/PP_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/PP_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="10%">ИВК: Тип: </td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="cpbmmCheck/DataHeader/IVK_Num"/>
              </td>
            </tr>
            <tr>
              <td align="left" width="25%" >
                Рабочая жидкость: <xsl:value-of select="cpbmmCheck/DataHeader/Prod_Name"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="cpbmmCheck/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="cpbmmCheck/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="77%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="cpbmmCheck/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <div>
          Заключение: δmax =&#160;<xsl:value-of select="cpbmmCheck/DataHeader/CPB_dKmax"/> %. ПР годен к дальнейшей эксплуатации (не годен и подлежит внеочередной поверке)
        </div>
        <br/>
        <div>
        ...
        <br/>
        <div>
          Дата проведения поверки:&#160;<xsl:value-of select="cpbmmCheck/DataHeader/STime"/>
        </div>
      </body>
    </html>
