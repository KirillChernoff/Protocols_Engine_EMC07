...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <head>
        <meta charset="utf-8"/>
        <title>поверки СРМ с помощью ЭПР и ПП по МИ 3381-2012</title>
      </head>
      ...
      <body scroll="no" >
        <div align="center">
          ПРОТОКОЛ №&#160;<xsl:value-of select="EvmmmVerification/DataHeader/ProtN"/>
        </div>
        <div align="center">поверки СРМ с помощью ЭПР и ПП по МИ 3381-2012</div>
        <br/>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения поверки: <xsl:value-of select="EvmmmVerification/DataHeader/Place"/>
              </td>
            </tr>
            <tr>
              ...
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/CurFM_Num"/>
              </td>
              <td align="right" width="15%">Линия №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/Len_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/CurFM_NamTr1"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/CurFM_Num1"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/EFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/EFM_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" width="20%">Тип:</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/PP_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/PP_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" width="20%">Тип:</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerification/DataHeader/IVK_Num"/>
              </td>
            </tr>

            <tr>
              <td align="left" width="50%" colspan="5">
                Рабочая жидкость:&#160;<xsl:value-of select="EvmmmVerification/DataHeader/Prod_Name"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center" width="11%">
                <xsl:value-of disable-output-escaping="yes" select="EvmmmVerification/DataHeader/Tab1HeadKMod"/>
              </td>
              <td align="center" width="11%">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerification/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerification/DataTab12">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerification/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center">
                <xsl:value-of disable-output-escaping="yes" select="EvmmmVerification/DataHeader/Tab22HeadKMod"/>
              </td>
            </tr>
            <tr>
              <td align="center" width="11%">1 </td>
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerification/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center">
                <xsl:value-of disable-output-escaping="yes" select="EvmmmVerification/DataHeader/Tab3HeadKMod"/>
              </td>
              <td align="center">
                n <sub>j</sub>
              </td>
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerification/DataTab3">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center">
                <xsl:value-of disable-output-escaping="yes" select="EvmmmVerification/DataHeader/Tab4HeadKMod"/>
              </td>
              <td align="center">
                S<sub>0</sub>,<br/>%
              </td>
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerification/DataTab4">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="77%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerification/DataTab42">
              <tr>
                <td align="center">
        ...
        <br/>
        <div>
          Дата проведения поверки:&#160;<xsl:value-of select="EvmmmVerification/DataHeader/STime"/>
        </div>
      </body>
    </html>
