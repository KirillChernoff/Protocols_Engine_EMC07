...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <head>
        <meta charset="utf-8"/>
        <title>Поверка ПР с помощью ПУ по МИ3287-2010</title>
      </head>
      ...
      <body scroll="no">
        <div align="center">ПРОТОКОЛ №<xsl:value-of select="PbvmVerification/DataHeader/ProtN"/></div>
        <div align="center">поверки ПР с помощью ПУ по МИ3287-2010</div>
        <br/>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения поверки: <xsl:value-of select="PbvmVerification/DataHeader/Place"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" width="20%">
                <xsl:value-of select="PbvmVerification/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="PbvmVerification/DataHeader/CurFM_Num"/>
              </td>
              <td align="right" width="15%">Линия №</td>
              <td align="left" width="10%">
                <xsl:value-of select="PbvmVerification/DataHeader/Len_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" >
                <xsl:value-of select="PbvmVerification/DataHeader/PB_NamTr"/>
              </td>
              <td align="left" >Заводской №</td>
              <td align="left" colspan="3">
                <xsl:value-of select="PbvmVerification/DataHeader/PB_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" >
                <xsl:value-of select="PbvmVerification/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" >Заводской №</td>
              <td align="left" colspan="3">
                <xsl:value-of select="PbvmVerification/DataHeader/IVK_Num"/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" >
                <xsl:value-of select="PbvmVerification/DataHeader/Prod_Name"/>
              </td>
              <td align="left" >
                Вязкость, мм<sup>2</sup>/c
              </td>
              <td align="left" colspan="3">
                <xsl:value-of select="PbvmVerification/DataHeader/Prod_KVis"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="88%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center" width="11%">V<sub>0</sub>,  м<sup>3</sup></td>
              <td align="center" width="11%">D, мм</td>
              <td align="center" width="11%">S, мм</td>
              <td align="center" width="11%">E, МПа</td>
              <td align="center" width="11%">α<sub>t доп</sub>,<br/>1/ºC</td>
              <td align="center" width="11%">α<sub>k1</sub>,<br/>1/ºC</td>
              <td align="center" width="11%">α<sub>d</sub>,<br/>1/ºC</td>
          ...
          <tbody>
            <xsl:for-each select="PbvmVerification/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="77%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              <td align="center" width="11%">θ<sub>SO</sub>,<br/>%</td>
              <td align="center" width="11%">θ<sub>VO</sub>,<br/>%</td>
              <td align="center" width="11%">Δt<sub>ПУ</sub>,<br/>ºC</td>
              <td align="center" width="11%">Δt<sub>ПР</sub>,<br/>ºC</td>
              <td align="center" width="11%">δt<sub>ИВК</sub>,<br/>%</td>
              <td align="center" width="11%">Δν,<br/>мм<sup>2</sup>/c</td>
              <td align="center" width="11%">KF,<br/>имп/м<sup>3</sup></td>
            </tr>
            <tr>
          ...
          <tbody>
            <xsl:for-each select="PbvmVerification/DataTab12">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbvmVerification/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbvmVerification/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="97%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              ...
              <td align="center" width="11%">
                <xsl:value-of disable-output-escaping="yes" select="PbvmVerification/DataHeader/Tab3_Arg"/>
              </td>
              <td align="center" width="11%">
          ...
          <tbody>
            <xsl:for-each select="PbvmVerification/DataTab3">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="PbvmVerification/DataTab4">
              <tr>
                <td align="center">
        ...
        <br/>
        <div>Дата проведения поверки:&#160;<xsl:value-of select="PbvmVerification/DataHeader/STime"/></div>
