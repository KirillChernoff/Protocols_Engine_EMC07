...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body scroll="no" >
        <div align="center">ПРОТОКОЛ №&#160;<xsl:value-of select="EvmmmVerificationKm/DataHeader/ProtN"/></div>
          ...
          <tbody>
            <tr>
              <td align="left" colspan="6" width="100%">
                Место проведения поверки: <xsl:value-of select="EvmmmVerificationKm/DataHeader/Place"/>
              </td>
            </tr>
            <tr height="25">
              ...
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/CurFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/CurFM_Num"/>
              </td>
              <td align="right" width="15%">Линия №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/Len_Num"/>
              </td>
            </tr>
            <tr height="25">
              ...
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/CurFM_NamTr1"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/CurFM_Num1"/>
              </td>
            </tr>
            <tr height="25">
              ...
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/EFM_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/EFM_Num"/>
              </td>
            </tr>
            <tr height="25">
              ...
              <td align="left" width="20%">Тип:</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/PP_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/PP_Num"/>
              </td>
            </tr>
            <tr height="25">
              ...
              <td align="left" width="20%">Тип:</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/IVK_NamTr"/>
              </td>
              <td align="left" width="15%">Заводской №</td>
              <td align="left" width="20%">
                <xsl:value-of select="EvmmmVerificationKm/DataHeader/IVK_Num"/>
              </td>
            </tr>
            <tr height="25">
              <td align="left" width="50%" colspan="5">
                Рабочая жидкость:&#160;<xsl:value-of select="EvmmmVerificationKm/DataHeader/Prod_Name"/>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKm/DataTab1">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <thead>
            <tr>
              <td align="center" width="12%">ZS,<br/>т/ч</td>
              <td align="center" width="11%">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKm/DataTab12">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKm/DataTab2">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKm/DataTab22">
              <tr>
                <td align="center">
                  <xsl:value-of select="ji"/>
                </td>
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKm/DataTab3">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKm/DataTab4">
              <tr>
                <td align="center">
        ...
        <table style="border-collapse:collapse;"  border="1" cellpadding="5" cellspacing="0" width="100%" bordercolor="#000000">
          ...
          <tbody>
            <xsl:for-each select="EvmmmVerificationKm/DataTab42">
              <tr>
                <td align="center">
        ...
        <br/>
        <div>
          Дата проведения поверки:&#160;<xsl:value-of select="EvmmmVerificationKm/DataHeader/STime"/>
        </div>
      </body>
    </html>
